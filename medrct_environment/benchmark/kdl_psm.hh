// Copyright  (C)  2009  Ruben Smits <ruben dot smits at mech dot kuleuven dot
// be>
...
Chain Puma560()
{
  ...
  puma560.addSegment(Segment(
      ...
      RigidBodyInertia(
          0, Vector::Zero(), RotationalInertia(0, 0.35, 0, 0, 0, 0))));
  puma560.addSegment(Segment(
      Joint(Joint::RotZ),
      Frame::DH(0.4318, 0.0, 0.0, 0.0),
      RigidBodyInertia(
          17.4,
          Vector(-.3638, .006, .2275),

...
if __name__ == '__main__':
    ...
    rospy.Subscriber(config_yaml['ros_communication'][0]['input']['waypoint_input'],Waypoints, mg.waypoint_callback)
    rospy.Subscriber(config_yaml['ros_communication'][0]['input']['trajectory_offset_topic'],Float32MultiArray, mg.offset_callback)
    ...
    rospy.Subscriber(config_yaml['toggle_topic'], Joy, mg.switching_callback)
